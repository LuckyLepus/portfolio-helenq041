...
const content = Buffer.concat([bom, Buffer.from(code, 'utf-8')]);
fs.writeFileSync('e:\\portfolio-helenq0414\\pdf_to_images.ps1', content);
console.log('Successfully wrote pdf_to_images.ps1 with UTF-8 BOM!');
